...
class AqaraHomeManager:
    ...
    def __init__(
        ...
        self, api: AqaraOpenAPI, device_manager: AqaraDeviceManager
    ):
        ...
        def __result_handler(data):
            for item in data:
                ...
                if query_sub_location :
                    sub_local_map = self._query_location_info(position_id, query_sub_location)
    ...
    def _query_scene_by_location(self, position_id: str) -> dict[str,Any] :        
        ...
        def __result_handler(data):
            for item in data:
                ...
                scene_map[item["sceneId"]] = item   # {"localizd": 0, "sceneId": "AL.832619739930738688",        "name": "123456",       "model": "app.scene.v1"   }   
